...
public class JavaScriptExecutorScenarios {
	...
	public static void javaScriptExeMethod(){
		...
		String s1Text =  js.executeScript("return document.title;").toString();
		System.out.println(s1Text);
		
		//to get the domain
		String s2Text =  js.executeScript("return document.domain;").toString();
		System.out.println(s2Text);
		
		//to get the URL of our webpage
		String s3Text =  js.executeScript("return document.URL;").toString();
		System.out.println(s3Text);
